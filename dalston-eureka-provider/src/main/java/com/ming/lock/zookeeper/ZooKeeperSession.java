...
public class ZooKeeperSession {
    ...
    private static int SESSION_TIMEOUT = 50000;
    ...
    public ZooKeeperSession() {
        ...
        try {
            ...
            //打印即时状态：验证其是不是异步的？
            logger.info("ZooKeeper status: "+String.valueOf(zookeeper.getState()));
    ...
    public static void main(String[] args) {
        ...
        //2、执行一些修改共享资源的操作
        logger.info("I am updating common resource in the main thread！");
        try {
            Thread.sleep(20000);
        } catch (InterruptedException e) {
            e.printStackTrace();
...
//                zkSession.acquireDistributedLock(adId);
//                //2、执行一些修改共享资源的操作
//                logger.info("I am updating common resource in the threadA！");
//                try {
//                    Thread.sleep(20000);
//                } catch (InterruptedException e) {
//                    e.printStackTrace();
...
//                zkSession.acquireDistributedLock(adId);
//                //2、执行一些修改共享资源的操作
//                logger.info("I am updating common resource in the threadB！");
//                //3、释放锁
//                zkSession.releaseDistributedLock(adId);
//            }
//        });
